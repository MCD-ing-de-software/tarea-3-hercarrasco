...
class TestDataCleaner(unittest.TestCase):
    ...
    def test_trim_strings_strips_whitespace_without_changing_other_columns(self):
        ...
        self.assertEqual(df["name"].tolist(), df_original["name"].tolist())
        self.assertEqual(df["city"].tolist(), df_original["city"].tolist())

        pdt.assert_series_equal(df["age"], df_original["age"], check_names=True)
